<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="单位性质" prop="danweixingzhi">
          <el-select :disabled="ro.danweixingzhi" v-model="ruleForm.danweixingzhi" placeholder="请选择单位性质">
            <el-option
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zerendanwei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zerendanweiCrossAddOrUpdateFlag = false;
						 this.parent.search();
